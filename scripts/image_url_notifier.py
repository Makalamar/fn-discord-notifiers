...
EGS_STORE_CONTENT_URL = (
    "https://store-content-ipv4.ak.epicgames.com/api/en-US/content/products/fortnite"
)
...
def fetch_egs_store_content_images() -> List[Media]:
    ...
    try:
        ...
        print(f"[EGS-STORE] Failed to fetch store content: {e}")
        return []
...
def collect_media() -> List[Media]:
    ...
    for fetch in (
        fetch_egs_store_content_images,
