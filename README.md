...
[![Stars](https://img.shields.io/github/stars/Makalamar/fn-discord-notifiers?style=social)](https://github.com/Makalamar/fn-discord-notifiers/stargazers)
[![Forks](https://img.shields.io/github/forks/Makalamar/fn-discord-notifiers?style=social)](https://github.com/Makalamar/fn-discord-notifiers/network/members)
...
- Tracks the storefront artwork Epic swaps in when a new Fortnite version ships:
  - **EGS Store Content API** → all `cdn2.unrealengine.com` artwork & screenshots (age rating logos and V-Bucks banners excluded)
...
- Posts clean embeds with:
  ...
  - The image as a thumbnail (small preview on the right)
